...
import decoration.RecycleViewDivider;
import observable.ImagesObservable;
import observable.ObserverListener;
...
public class PictureAlbumDirectoryActivity extends PictureBaseActivity implements View.OnClickListener, PictureAlbumDirectoryAdapter.OnItemClickListener, ObserverListener {
    ...
    private TextView picture_tv_title, picture_tv_right,picture_tv_left;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.e("Directory", "DirectoryActivity");
        ...
        picture_tv_left = (TextView) findViewById(R.id.picture_tv_left);
        ...
        Log.e("is_top_activity",is_top_activity+"");
        if (!is_top_activity) {
        ...
        picture_tv_left.setText(getString(R.string.cancel));
        picture_tv_left.setOnClickListener(this);
        picture_tv_right.setText("完成");
    ...
    private void showDialog(String msg) {
        dialog = new SweetAlertDialog(PictureAlbumDirectoryActivity.this);
    ...
    public void onClick(View view) {
        ...
        } else if (id == R.id.picture_tv_left) {
            finish();
            overridePendingTransition(0, R.anim.slide_bottom_out);
